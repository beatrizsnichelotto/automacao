# Caminhos de login
signin = '//*[@id="__next"]/header/div[2]/div/div[2]/div/div[1]/a[2]'
...
signUp = '//*[@id="__next"]/header/div[2]/div/div[2]/div/div[1]/a[1]'
...
pesquisaProduto = '//*[@id="__next"]/header/div[2]/div/div[1]/div[4]/div/div[2]/input'
...
carrinho = '//*[@id="__next"]/header/div[2]/div/div[2]/div/button'
...
entrar = '//*[@id="step-components"]/div/div[2]/form/div/div[4]/button'
...
formaPagamento = '//*[@id="step-components"]/div/div/div/ul/li[1]/div/div[1]/div[1]/div[2]/span'
finalizarPagamento = '//*[@id="step-components"]/div/div/div/ul/li[1]/div/div[2]/div/div/div/div/div/div[2]/div/button'
...
showSigninPassword = '//*[@id="__next"]/main/section/div/div/div/div/form/div/div[2]/div/button'
login = '//*[@id="__next"]/main/section/div/div/div/div/form/div/div[4]/button'
atualizar = '//*[@id="__next"]/header/div[2]/div/div[1]/div[1]/a'
pesquisaProduto = '//*[@id="__next"]/header/div[2]/div/div[1]/div[4]/div/div[2]/input'
selecionaProduto = '//*[@id="products-show-case-category"]/div/div[3]/div[2]/a/div' 
addCarrinho = '//*[@id="__next"]/main/div/div[1]/div[1]/div/div[3]/ul/li[4]/div[1]/button'
carrinho = '//*[@id="__next"]/header/div[2]/div/div[2]/div/button' 
fecharPedido = '//*[@id="fade-menu"]/div[3]/ul/li[3]/div[4]/div[1]'
opcaoEnvio = '//*[@id="step-components"]/div/div[2]/div[2]/div/ul/li/div/label/span[1]'
formaPagamento = '//*[@id="step-components"]/div/div/div/ul/li[1]/div/div[1]/div[1]/div[2]/span'
finalizarPagamento = '//*[@id="step-components"]/div/div/div/ul/li[1]/div/div[2]/div/div/div/div/div/div[2]/div/button'
...
showSigninPassword = '//*[@id="__next"]/main/section/div/div/div/div/form/div/div[2]/div/button'
login = '//*[@id="__next"]/main/section/div/div/div/div/form/div/div[4]/button'
icon = '//*[@id="__next"]/header/div[2]/div/div[2]/div/div[2]/button'
meusPedidos = '/html/body/div[7]/div[3]/ul/li[2]'
ultimosPedidos = '//*[@id="__next"]/main/section/div[2]/div[1]/nav/div/div[2]/div[2]/div/div/div/div/ul/li[1]'
logout = '/html/body/div[4]/div[3]/ul/li[3]'
...
login = '//*[@id="__next"]/main/section/div/div/div/div/form/div/div[4]/button'
icon = '//*[@id="__next"]/header/div[2]/div/div[2]/div/div[2]/button'
minhaConta = '/html/body/div[7]/div[3]/ul/li[1]'
...
confirmarExclusaoTel = '/html/body/div[10]/div[3]/div/div[3]/button[1]'
...
confirmarExclusaoEnd = '/html/body/div[10]/div[3]/div/div[3]/button[1]'
...
confirmarExclusaoEmail = '/html/body/div[10]/div[3]/div/div[3]/button[1]'
...
emailRecuperacao = '/html/body/div[4]/div[3]/div/div[2]/div/div/form/div/div[2]/div/div/input'
recuperar = '/html/body/div[4]/div[3]/div/div[2]/div/div/form/div/div[4]/button'
